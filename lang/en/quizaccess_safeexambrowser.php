<?php
    ...
    $string['safebrowserconfiglink'] = 'Use this link to start the quiz with an approved version of Safe Exam Browser: {$a->link}';
    $string['safebrowserstartexamlink'] = 'Start exam';
    $string['safebrowserdownloadlink'] = 'If you do not have Safe Exam Browser installed, you can download it from {$a->link}.';
